...
<head lang="en">
	...
	<![endif]-->
<link rel="stylesheet" href="{{asset('assetsAdmin/css/lib/lobipanel/lobipanel.min.css')}}">
<link rel="stylesheet" href="{{asset('assetsAdmin/css/separate/vendor/lobipanel.min.css')}}">
<link rel="stylesheet" href="{{asset('assetsAdmin/css/lib/jqueryui/jquery-ui.min.css')}}">
<link rel="stylesheet" href="{{asset('assetsAdmin/css/separate/pages/widgets.min.css')}}">
    <link rel="stylesheet" href="{{asset('assetsAdmin/css/lib/font-awesome/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('assetsAdmin/css/lib/bootstrap/bootstrap.min.css')}}">
...
<body class="with-side-menu dark-theme">
	...
	<script src="{{asset('assetsAdmin/js/lib/jquery/jquery-3.2.1.min.js')}}"></script>
	<script src="{{asset('assetsAdmin/js/lib/popper/popper.min.js')}}"></script>
	<script src="{{asset('assetsAdmin/js/lib/tether/tether.min.js')}}"></script>
	<script src="{{asset('assetsAdmin/js/lib/bootstrap/bootstrap.min.js')}}"></script>
	<script src="{{asset('assetsAdmin/js/plugins.js')}}"></script>
	<script src="{{asset('assetsAdmin/js/lib/datatables-net/datatables.min.js')}}"></script>

	<script type="text/javascript" src="{{asset('assetsAdmin/js/lib/jqueryui/jquery-ui.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assetsAdmin/js/lib/lobipanel/lobipanel.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assetsAdmin/js/lib/match-height/jquery.matchHeight.min.js')}}"></script>
